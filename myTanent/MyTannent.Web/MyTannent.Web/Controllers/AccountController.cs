    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //id = Guid.Parse("eebeda24-f342-4ad0-9e35-6910eac102de");
                HttpResponseMessage responseMessage = await client.GetAsync(AccountApiUrl + "/" + model.UserId);
                ...
                if (userModel != null)
                {
                    if (model.password == userModel.password)
                    {
                        ...
                        //else
                        //{
                        //    ModelState.AddModelError("", "User is not activated by admin team. please wait for some time.");
                        //    return View(model);
                        //}
                    }
                    else
